...
const ResX0 = {
  ...
  technologies: ["Flutter", "Firebase", "React", "Node.js", "C#", "Python"],
  databases   : ["Firestore", "SQL Server", "MongoDB", "SQLite"],
  currentWork : "Building premium digital solutions worldwide 🌍",
...
|---------|------|-----------|-------------|
| 🏥 **MedCore Health** | Flutter App | Flutter, Firebase | Complete Hospital Management System |
| 🏪 **Sales Management System** | Desktop App | C#, WinForms, SQL Server | Professional POS & Inventory System |
| 🤖 **StoreBot Platform** | Telegram Bot | Node.js, Python, Telegram API | Automated Telegram Store Platform |
| 🛒 **E-Commerce Store** | Website | React, Firebase, Vite | Modern Full-Stack E-Commerce |
| ✅ **TaskFlow Pro** | Flutter App | Flutter, Firebase | Team & Project Management App |
| ⚙️ **Business Automation** | Platform | Cloud, CRM, Analytics | Digital Business Automation Suite |
...
[![Telegram](https://img.shields.io/badge/Telegram-2CA5E0?style=for-the-badge&logo=telegram&logoColor=white)](https://t.me/ResX01)
